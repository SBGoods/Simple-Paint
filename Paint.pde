...
Pair<Integer,Integer> start = new Pair<Integer, Integer>(60, 120);
Pair<Integer,Integer> end = new Pair<Integer, Integer>(150, 180);
ArrayList<Integer> colors6 = new ArrayList<Integer>();
colors6.add(0);
colors6.add(0);
colors6.add(0);
Shape line = new Shape(colors6, start, end);
list.add(line);
